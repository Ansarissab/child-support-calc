...
function ecalc_main() {
    jQuery(document).ready(function($) {
        ...
        /******* Load HTML *******/
        var calchtml = "<div class=calc_container><h6><a href=https:\/\/www.childsupportcalculator.ca\/ >Child Support Calculator<\/a><br\/>for Prince Edward Island<\/h6><hr><div><form id=ecalc><div><div><label>Payor Income<\/label><input type=number placeholder=80,000 name=income1><\/div><div><label>Number of Children<\/label><select name=cscchildren><option selected value=-1>\u2013Select\u2013<option value=1>1<option value=2>2<option value=3>3<option value=4>4<option value=5>5<option value=6>6+<\/select><\/div><\/div><input type=hidden name=residence1 value=\"Prince Edward Island\"><input type=hidden name=spousal value=no><input type=hidden name=haschildren value=yes><div id=ecalc_result style=display:none><\/div><div><input type=submit value=Calculate*><\/div><p>*By using this child support calculator, you agree with the <a href=https:\/\/www.childsupportcalculator.ca\/#terms target=new>calculator terms of use<\/a><\/form><iframe id=ecalculatorFrame style=display:none src=https:\/\/support-calculator.herokuapp.com\/calculatorFrame><\/iframe><\/div><\/div>"
